...
from django.contrib.auth.views import logout as real_logout
...
def login_present(request):
    return render(request, 'login_page.html', {'UserLoginForm' : UserLoginForm})
...
def authenticate_login(request):
    ...
    if user is not None:
        login(request, user)
        return render(request, 'thanks_for_logging_in.html', {})
